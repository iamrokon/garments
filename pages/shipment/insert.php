...
<?php
      ...
      $result = $ob->select_all_finishing_not_in_shipment();
                                ...
                                <?php
                                  ...
                                  <tr>
                                      ...
                                      <td class="td-actions" class="text-center">
                                          <a href="./pages/shipment/details.php?id=<?php echo $info['id']; ?>"><button class="btn  btn-xs btn-success">Details</button></a>
                                      </td>
                                  </tr>
                                 <?php $i++;} ?>
                              </tbody>
