            ...
            <div class="form-group" style="height:500px;" id="myDIV">
              <div class="w3-table-all w3-small" id="add_row">
                <table class="w3-table-all w3-small" border="1">
                  ...
                  <?php
                  $i = 1;
                   foreach ($result as $planning_info){
                    ?>

                    <tr style="color:black;">

                    <td class="text-center">
                      <?php echo $planning_info['buyer_name'];?>
                    </td>

                    <td class="text-center">
                      <?php echo $planning_info['style_name']; ?>
                    </td>
                    <td class="text-center">
                        <?php echo $planning_info['projected_qty']; ?>
                    </td>

                     <td class="text-center">
                       <?php echo $planning_info['po_number'];?>
                     </td>

                     <td class="text-center">
                       <?php echo $planning_info['color_name'];?>
                     </td>
                     <td class="text-center">
                         <?php echo $planning_info['dely_date'];?>
                     </td>
                     <td class="text-center">
                         <?php echo $planning_info['order_qty'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['cutting_plan_qty'];?>
                     </td>
                     <td class="text-center">
                         <?php echo $planning_info['cutting_plan'];?>
                     </td>


                     <td class="text-center">
                       <?php echo $planning_info['today_cut_pro_qty'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['total_cut_pro_qty'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['cutting_balance'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['cutting'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['cutting_status'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['today_iissue'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['total_iissue'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['input_balance'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['input_status'];?>
                     </td>

                     <td class="text-center">
                       <?php echo $planning_info['today_soutput'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['total_soutput'];?>
                     </td>
                    <td class="text-center">
                      <?php echo $planning_info['sewing_rejection_qty'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['wip_in_line'];?>
                    </td>

                     <td class="text-center">
                       <?php echo $planning_info['today_wsend'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['total_wsend'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['wsend_balance'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['w_rejection'];?>
                     </td>
                     <td class="text-center">
                       <?php echo $planning_info['wip_at_wash'];?>
                     </td>
                    <td class="text-center">
                      <?php echo $planning_info['today_fin_in'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['total_fin_in'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['today_fin_out'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['total_fin_out'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['fin_out_perc'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['fin_rejection_qty'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['wip_at_finish'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['tot_fin_rejection_qty'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['today_ship'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['total_ship'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['bal_to_ship'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['order_to_ship'];?>
                    </td>
                    <td class="text-center">
                      <?php echo $planning_info['cut_to_ship'];?>
                    </td>
                     ...
                     <td class="text-center">
                       <?php echo $planning_info['remarks'];?>
                     </td>
