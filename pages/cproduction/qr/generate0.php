        ...
        $filename = $PNG_TEMP_DIR.'test.png';
             ...
             while ($row_p = mysqli_fetch_assoc($cproduction_process_result))
               ...
               for($k=0; $k<$print_number; $k++){
                ...
                $pdf->Image($filename,2,2,22,41);

                $pdf->Text(10,45,$bundle_part);

                $pdf->Text(25,5,'Bundle :');
                $pdf->Text(25,9,'Style:');
                $pdf->Text(25,13,'Buyer:');
                $pdf->Text(25,17,'Color:');
                $pdf->Text(25,21,'PO:');
                $pdf->Text(25,25,'Cut No:');
                $pdf->Text(25,29,'SR From:');
                ...
                $pdf->Text(37,9,$style);
                $pdf->Text(37,13,$buyer);
                $pdf->Text(37,17,$color);
                $pdf->Text(37,21,$po);
                $pdf->Text(37,25,$cut_number);
                $pdf->Text(37,29,$from_id);
                $pdf->Text(37,33,$to_id);
                $pdf->Text(37,37,$quantity);
                $pdf->Text(37,41,$ticket_size);
                }
           	  }
            }
                  $pdf->Output();
