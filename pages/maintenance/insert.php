...
<?php require_once '../../DB/maintenance/insert.php'; ?>
...
if (isset($_POST['btn'])) {
    ...
    for ($i = 1; $i <= $count; $i++) {
        ...
        $insert_id = $maintenanceInsert->save(
                   $_POST['mc_model_'.$i],
                   $_POST['mc_type_'.$i],
                   $_POST['rack_no_'.$i],
                   $_POST['box_no_'.$i],
        ...
        for ($j = 1; $j <= $days_in_month; $j++) {
          $ij = $i."_".$j;
          $mgs = $maintenanceInsert->save_daily_issue_qty(
                   $insert_id,
                   $_POST['day_'.$j],
                  ...
                  $i = 1;
                   //foreach ($item_list as $item_name){
                    ...
                    <td class="text-center">
                     ...
                     <td class="text-center">
                       <input style="width:90px;" type="text" name="mc_model_<?php echo $i;?>" id="mc_model_<?php echo $i?>">
                       <input type="hidden" name="month_<?php echo $i;?>" id="month_<?php echo $i?>" value="<?php echo $month;?>">
                       <input type="hidden" name="year_<?php echo $i;?>" id="year_<?php echo $i?>" value="<?php echo $year;?>">
                     </td>


                     <td class="text-center">
                       <input style="width:90px;" type="text" name="mc_type_<?php echo $i;?>" id="mc_type_<?php echo $i?>">

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="text" name="rack_no_<?php echo $i;?>" id="rack_no_<?php echo $i?>">

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="text" name="box_no_<?php echo $i;?>" id="box_no_<?php echo $i?>">

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="text" value="<?php echo $item_name['name'];?>" >
                        <input style="width:90px;" type="hidden" name="item_name_<?php echo $i;?>" id="item_name_<?php echo $i;?>" value="<?php echo $item_name['id'];?>" >

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="text" name="parts_number_<?php echo $i;?>" id="parts_number_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="text" name="rec_challan_no_<?php echo $i;?>" id="rec_challan_no_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                        <input style="width:135px;" type="date" name="today_rec_date_<?php echo $i;?>" id="today_rec_date_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="number" step="0.01" name="today_received_<?php echo $i;?>" id="today_received_<?php echo $i;?>" onkeyup="totalReceived(this.value,<?php echo $i;?>)" value="" >

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="number" step="0.01" name="prev_received_<?php echo $i;?>" id="prev_received_<?php echo $i;?>" onkeyup="totalReceived(this.value,<?php echo $i;?>)" value="" >

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="number" step="0.01" name="tot_received_<?php echo $i;?>" id="tot_received_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="text" name="prev_stock_<?php echo $i;?>" id="prev_stock_<?php echo $i;?>" value="" onkeyup="totalStock(this.value,<?php echo $i;?>)"  >

                     </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="tot_stock_qty_<?php echo $i;?>" id="tot_stock_qty_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="text" name="unit_<?php echo $i;?>" id="unit_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="number" step="0.01" name="unit_price_<?php echo $i;?>" id="unit_price_<?php echo $i;?>" value="" onkeyup="totalPrice(<?php echo $i;?>)" >
                     ...
                     <td class="text-center">
                        ...
                        <input style="width:40px;" type="number" step="0.01" name="daily_issue_qty_<?php echo $j;?>" class="daily_issue_qty_<?php echo $i;?>" onkeyup="totalDailyIssue(this.value,<?php echo $i;?>)" >

                      </td>
                      <?php } ?>
                     <td class="text-center">
                        <input style="width:90px;" type="number" step="0.01" name="day_issue_<?php echo $i;?>" id="day_issue_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="prev_issue_<?php echo $i;?>" id="prev_issue_<?php echo $i;?>" value="" onkeyup="totalIssue(this.value,<?php echo $i;?>),totalBalance(<?php echo $i;?>),totalPrice(<?php echo $i;?>)" >

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="tot_issue_<?php echo $i;?>" id="tot_issue_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="tot_balance_<?php echo $i;?>" id="tot_balance_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="tot_price_<?php echo $i;?>" id="tot_price_<?php echo $i;?>" value="" >

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="next_order_qty_<?php echo $i;?>" id="next_order_qty_<?php echo $i;?>" value="" onkeyup="nextTotal(<?php echo $i;?>)" >

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="next_unit_price_<?php echo $i;?>" id="next_unit_price_<?php echo $i;?>" value="" onkeyup="nextTotal(<?php echo $i;?>)" >

                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="next_tot_price_<?php echo $i;?>" id="next_tot_price_<?php echo $i;?>" value="" >
