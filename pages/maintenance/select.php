...
<?php
      ...
      if (isset($_POST['search'])) {
          $result = $ob->select_all($_POST['month'],$_POST['year']);
          $month = $_POST['month'];
          $year = $_POST['year'];
      }
?>
...
if(!$result){
  $result = $ob->select_all($month,$year);
}
?>
          ...
          <form method="post" enctype="multipart/form-data" action="" name="form1">
            ...
            <div class="form-group" style="height:500px;" id="myDIV">
              <div class="w3-table-all w3-small" id="add_row">
                <table id="export-table" class="w3-table-all w3-small" border="1">
                  <thead>
                  ...
                  <?php
                  $i = 1;
                   foreach ($result as $maintenaceInfo){
                    ?>
                    ...
                    <td class="text-center">
                     ...
                     <td class="text-center">
                       <?php echo $maintenaceInfo['mc_model']; ?>
                     ...
                     <td class="text-center">
                       <?php echo $maintenaceInfo['mc_type']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['rack_no']; ?>
                      </td>
                     <td class="text-center">
                     ...
                     <td class="text-center">
                         ...
                         <?php echo $maintenaceInfo['item_name']; ?>
                     ...
                     <td class="text-center">
                         ...
                         <?php echo $maintenaceInfo['rec_challan_no']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['today_rec_date']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['today_received']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['prev_received']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['tot_received']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['prev_stock']; ?>

                     </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['tot_stock_qty']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['unit']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['unit_price']; ?>
                      ...
                      for($j=1;$j<=$days_in_month;$j++){
                        ...
                        $daily_issue_qty = $ob->select_daily_issue_qty($maintenaceInfo['id'],$j,$month,$year);
                        $daily_issue_qty_info = mysqli_fetch_assoc($daily_issue_qty);
                        //
                        // echo '<pre>';
                        // print_r($month);
                        // echo '</pre>';
                     ...
                     <td class="text-center">
                        ...
                        <?php echo ($daily_issue_qty_info['daily_issue_qty']);?>

                      </td>
                      <?php } ?>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['day_issue']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['prev_issue']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['tot_issue']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['tot_balance']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['tot_price']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['next_order_qty']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['next_unit_price']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['next_tot_price']; ?>

                      </td>
                     <td class="text-center">

                         <?php echo $maintenaceInfo['remarks']; ?>

                     </td>
                      <td class="td-actions" class="text-center">
                          <a href="./pages/maintenance/update.php?id=<?php echo $maintenaceInfo['id'];?>"><button class="btn badge-text badge-text-small info">Update</button></a>
                          <a href="./pages/maintenance/delete.php?id=<?php echo $maintenaceInfo['id'];?>"><button class="btn badge-text badge-text-small danger">Delete</button></a>
                      </td>
