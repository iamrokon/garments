...
<thead>
                  ...
                  foreach ($trinhouse_details_info as $trinhouse_details){
                    ...
                    <td class="text-center">
                     ...
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="d_receive_quantity_<?php echo $i;?>" id="d_receive_quantity_<?php echo $i?>" value="" onkeyup="totalReceiveQty(<?php echo ($i);?>)">
                      </td>
                     <td class="text-center">
                       <input style="width:90px;" type="number" step="0.01" name="receive_quantity_<?php echo $i;?>" id="receive_quantity_<?php echo $i?>" value="<?php echo $trinhouse_details['receive_quantity']; ?>" onkeyup="balanceQuantity(<?php echo ($i);?>)">
                       <input type="hidden" id="prev_receive_quantity_<?php echo $i?>" value="<?php echo $trinhouse_details['receive_quantity']; ?>">
                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="number" step="0.01" name="d_issue_quantity_<?php echo $i;?>" id="d_issue_quantity_<?php echo $i?>" value="" onkeyup="totalIssueQty(<?php echo ($i);?>)">

                      </td>
                     <td class="text-center">
                        <input style="width:90px;" type="number" step="0.01" name="total_issue_quantity_<?php echo $i;?>" id="total_issue_quantity_<?php echo $i?>" value="<?php echo $trinhouse_details['total_issue_quantity']; ?>" onkeyup="balanceQuantity(<?php echo ($i);?>)">
...
function addNewRow(){
  ...
  rowItem = '<tr>'
             ...
             +'<td><input type="number" style="width:90px;" id="d_receive_quantity_'+count+'" name="d_receive_quantity_'+count+'" step="0.01"  ></td>'
             ...
             +'<td><input type="number" style="width:90px;" id="d_issue_quantity_'+count+'" name="d_issue_quantity_'+count+'" step="0.01"></td>'
