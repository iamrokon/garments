                ...
                <table class="w3-table-all w3-small" border="1">
                  <thead>
                    <tr class="btn-gradient-01">
                      ...
                      <td class="text-center">TTL TOD</th>
                      <td class="text-center">Season</td>
                      <td class="text-center">ORDER QTY</td>
                      <td class="text-center">SHIP QTY</td>
                      <td class="text-center">COUNTRY</td>
                      <td class="text-center">Inspection Qty</td>
                      <td class="text-center">SKIP</td>
                      <td class="text-center" colspan="2">INITIAL</td>
                      <td class="text-center" colspan="2">INLINE</td>
                      <td class="text-center" colspan="2">FINAL</td>
                      <td class="text-center">CRITICAL FAULT</td>
                      <td class="text-center">MAJOR FAULTS</td>
                      <td class="text-center">DEFECT QTY:</td>
                      <td class="text-center">DEFECT DETAILS</td>
                      <td class="text-center">RAMARKS</td>
                      <td class="text-center">INS . BY</td>
                    </tr>
                    <tr class="btn-gradient-01">
