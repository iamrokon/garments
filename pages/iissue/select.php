...
<?php
      ...
      $result = $ob->select_all_input_issue();
                                ...
                                <?php
                                  ...
                                  <tr>
                                      ...
                                      <td class="td-actions" class="text-center">
                                          <a href="./pages/iissue/details_iissue.php?id=<?php echo $info['id']; ?>"><button class="btn badge-text badge-text-small info">Details</button></a>
                                      </td>
                                  </tr>
                                 <?php $i++;} ?>
                              </tbody>
