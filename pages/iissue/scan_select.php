                              ...
                              <tbody>
                                <?php
                                  ...
                                  <tr>
                                      ...
                                      <td style="color:black;" class="text-center"><?php echo $info['quantity']; ?> </td>
                                      ...
                                      <td style="color:black;" class="text-center"><?php echo $info['color']; ?> </td>
                                      <td style="color:black;width:100px;" class="text-center"><?php echo $info['style_name']; ?> </td>
