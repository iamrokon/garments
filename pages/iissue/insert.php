            ...
            <div class="table-responsive w3-card-4 table-striped w3-hoverable w3-small" style="padding:25px;">
              ...
              <table id="export-table" class="table table-striped w3-hoverable display nowrap w3-table-all w3-small" style="width:100%" style="overflow-x:auto;">
                      ...
                      <tr  class="btn-gradient-02">
                                    ...
                                    <th style="color:white;">Cutting Quantity</th>
                                  ...
                                  <tr>
                                      ...
                                      <td style="color:black;">
                                        ...
                                        while ($country = mysqli_fetch_assoc($countryList)) {
                                          $orderSumQuantity = $select_order->select_quantity_sum_order_and_country($info['id'],$country['country_id']);
                                      ...
                                      <td class="td-actions" class="text-center">
                                          <a href="./pages/iissue/details.php?id=<?php echo $info['id']; ?>"><button class="btn badge-text badge-text-small info">Input Issue</button></a>
                                      </td>
                                  </tr>
                                 <?php
                                      $i++;
                              ...
                              <?php ?>
                                <tfoot>
                                    <tr class="btn-gradient-02">
                                        ...
                                        <td style="font-weight: bold;"></td>
                                        <td style="font-weight: bold;">Total Cutting Quantity&nbsp;&nbsp;&nbsp;<?php echo $totalCut; ?></td>
                                        <td style="font-weight: bold;"></td>
                                        <td style="font-weight: bold;"></td>
                                        <td style="font-weight: bold;"></td>
                                        <td style="font-weight: bold;"></td>
