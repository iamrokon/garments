...
<?php require_once '../../DB/style/delete.php'; ?>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input disabled type="text" class="form-control" name="style_name" value="<?php echo $data['style_name']; ?>" placeholder ="Enter Style Name" required="">
