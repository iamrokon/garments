...
<?php
      ...
      $soutput_qty_date = $ob->select_tot_soutput_qty_date($from_date,$to_date);
      $tot_soutput_qty_date_info = mysqli_fetch_assoc($soutput_qty_date);
      $tot_soutput_qty_date=$tot_soutput_qty_date_info['totRow'];
...
while ($info = mysqli_fetch_assoc($result)) {
 $j=0;
    ...
    $soutput_qty = $ob->select_soutput_qty_date($info['po'],$from_date,$to_date);
    ...
    $subdata[]='<a href="./pages/swoutput/style_wise_sewing2.php?id='.$info['id'].'&from_date='.$from_date.'&to_date='.$to_date.'"><button class="btn badge-text badge-text-small w3-orange">Sewing</button></a>';
    $data[]=$subdata;
    $i++;
}
...
$json_data=array(
    ...
    "tot_soutput_qty_date"      =>  intval($tot_soutput_qty_date),
