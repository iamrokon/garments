...
<?php
      ...
      $result = $ob->select_all_input_issue_not_in_swing();
                                ...
                                <?php
                                  ...
                                  <tr>
                                      ...
                                      <td class="td-actions" class="text-center">
                                          <a href="./pages/swoutput/details.php?id=<?php echo $info['id']; ?>"><button class="btn  btn-xs btn-success">Details</button></a>
                                      </td>
                                      <td class="td-actions" class="text-center">
                                          <a href="./pages/qr/generate.php?id=<?php echo $info['id']; ?>"><button class="btn  btn-xs btn-danger">QR Code</button></a>
                                      </td>
                                  </tr>
                                 <?php $i++;} ?>
                              </tbody>
