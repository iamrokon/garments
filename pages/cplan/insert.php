                              ...
                              <tbody>
                                <?php
                                  ...
                                  <tr>
                                      ...
                                      <td style="color:black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $quantity = $info['total_quantity']; ?> </td>
                                      <td style="color:black;width:100px;" class="text-center"><?php echo $info['creation_date']; ?> </td>
                                      ...
                                      <td class="td-actions" class="text-center">
                                          <a href="./pages/cplan/details.php?id=<?php echo $info['id']; ?>"><button class="btn badge-text badge-text-small info">Set Cutting (%)</button></a>
                                      </td>
                                  </tr>
                                 <?php
                                      $i++;
