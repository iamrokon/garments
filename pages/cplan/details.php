               ...
               <div class="input-group margin" style="margin-top: 20px">
                 ...
                 <div class="row" style="padding-right: 10px;padding-left: 10px; padding-top: 10px;">
                   ...
                   <div class="table-responsive">
                    ...
                    <form method="post" enctype="multipart/form-data" action="" class="needs-validation" novalidate style="margin-top:50px;margin-left:20px;">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                 ...
                                 <label class="form-control-label">Cutting (%)<span style="color:red;">*</span></label>

                                 <div class="input-group">
                                     <span class="input-group-addon addon-primary">
                                         <i class="la la-file-text"></i>
                                     </span>
                                     <input type="text" class="form-control" name="cutting_plan" placeholder ="Enter Cutting (%)" required="required">
                                 </div>
                             </div>
                          </div>
                          ...
                          <div class="col-md-6">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="text-center" style="margin-top: 35px;">
                                    <button name="btn" class="btn btn-gradient-03" type="submit">SUBMIT</button>
                                  </div>
