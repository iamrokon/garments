...
if (isset($_POST['btn'])) {
    ...
    // $message = $update->update_trinhouse_info_by_id(
    //                                             $trinhouse_id,
    //                                             $challan,
    //                                             $issue_date,
    //                                             $item_name,
    ...
    <div class="w3-animate-right">
        ...
        <div class="box-default widget-body">
            ...
            <div class="form-group" id="itemName" style="display:none;">
              <div>
                <table class="w3-table-all w3-small" border="1" style="width:230px;">
            ...
            <div class="form-group" id="headerName" style="display:none" >
                <table class="w3-table-all w3-small" style="margin-top: 0px;width:2880px">
                  <thead>
                  <tr class="btn-gradient-01">
                    <td class="text-center" width="70px">SL</td>
                    <td class="text-center" width="160px">Item Name</td>
                    ...
                    <td class="text-center" width="80px">Action</td>
                  </tr>
                  </thead>
            ...
            <div class="form-group" style="height:500px;" id="myDIV">
                <table class="w3-table-all w3-small" border="1" style="width:2880">
<thead>
                  <tr class="btn-gradient-01">
                    <td class="text-center" width="70px">SL</td>
                    <td class="text-center" width="160px">Item Name</td>
                  ...
                  foreach ($trinhouse_details_info as $trinhouse_details){
                    ...
                    <td class="text-center">
                      <?php echo $trinhouse_details['challan']; ?>

                     </td>
                    <td class="text-center">

                      <?php echo $trinhouse_details['issue_date']; ?>
                    </td>
                    <td class="text-center">
                    ...
                    <td class="text-center">
                      <?php echo $trinhouse_details['pcd']; ?>
                    </td>
                    <td class="text-center">
                        <?php echo $trinhouse_details['tod_from']; ?>
                    </td>
                    <td class="text-center">
                        <?php echo $trinhouse_details['tod_to']; ?>
                    </td>

                     <td class="text-center">
                       <?php echo $trinhouse_details['country']; ?>
                     </td>
                    <td class="text-center">
                    ...
                    <td class="text-center">
                      <?php echo $trinhouse_details['item_color']; ?>

                    </td>
                    <td class="text-center">
                      <?php echo $trinhouse_details['size']; ?>
                    </td>


                     <td class="text-center">
                       <?php echo $trinhouse_details['shade']; ?>
                     </td>

                    <td class="text-center">
                      <?php echo $trinhouse_details['ref_no']; ?>

                    </td>
                    <td class="text-center">
                      <?php echo $trinhouse_details['unit_type']; ?>

                    </td>
                    <td class="text-center">
                      <?php echo $trinhouse_details['cons']; ?>

                     </td>
                     <td class="text-center">
                       <?php echo $trinhouse_details['actual_quantity']; ?>
                     </td>
                     <td class="text-center">
                       <?php
                     ...
                     <td class="text-center">
                       <?php echo $trinhouse_details['receive_quantity']; ?>
                      </td>
                     <td class="text-center">
                        <?php echo $trinhouse_details['total_issue_quantity']; ?>
                      </td>
                     <td class="text-center">
                       <?php echo $trinhouse_details['balance_quantity']; ?>
                      </td>
                     <td class="text-center">
                        <?php echo $trinhouse_details['remarks']; ?>
                       </td>
                     <td class="td-actions" class="text-center" style="padding:4px 10px">
                         <a href="./pages/trinhouse/delete_trinhouse_name.php?id=<?php echo $trinhouse_details['id']; ?>"><button class="btn  btn-xs btn-success" style="padding:3px 10px">Delete</button></a>
                     </td>
       ...
       <div class="text-center" style="padding-bottom: 10px;">
          <a href="./pages/trinhouse/trinhouse_detail_excel.php?id=<?php echo $trinhouse_id; ?>"><button class="btn badge-text badge-text-small w3-green">Excel</button></a>
        </div>
...
function addNewRow(){
  ...
  //            +'<td><input type="text" style="width:90px;height:18px;" id="challan_'+count+'" name="challan_'+count+'" ></td>'
  //            +'<td><input type="date" style="width:140px;height:18px;" id="issue_date_'+count+'" name="issue_date_'+count+'" value="<?php echo date("Y-m-d"); ?>" ></td>'
  //            +'<td>'
  ...
  //
  //            +'<td>'
  //            +'<select id="line_select_'+count+'" name="line_select_'+count+'" >'
  //            +'<?php echo $line_select_option; ?>'
  //            +'</select>'
  //            +'</td>'
  //
  //            +'<td>'
  //            +'<select id="style_select_'+count+'" name="style_select_'+count+'" >'
  //            +'<?php echo $style_select_option; ?>'
  //            +'</select>'
  //            +'</td>'
  //
  //            +'<td>'
  //            +'<select id="po_select_'+count+'" name="po_select_'+count+'" >'
  //            +'<?php echo $po_select_option; ?>'
  //            +'</select>'
  //            +'</td>'
  //
  //            +'<td><input type="date" style="width:140px;height:18px;" id="pcd_'+count+'" name="pcd_'+count+'" value="<?php echo date("Y-m-d"); ?>" ></td>'
  //            +'<td><input type="date" style="width:140px;height:18px;" id="tod_from_'+count+'" name="tod_from_'+count+'" value="<?php echo date("Y-m-d"); ?>" ></td>'
  //            +'<td><input type="date" style="width:140px;height:18px;" id="tod_to_'+count+'" name="tod_to_'+count+'" value="<?php echo date("Y-m-d"); ?>" ></td>'
  //
  //            +'<td>'
  //            +'<select id="supplier_select_'+count+'" name="supplier_select_'+count+'" >'
  //            +'<?php echo $supplier_select_option; ?>'
  //            +'</select>'
  //            +'</td>'
  //
  //            +'<td>'
  //            +'<select id="color_select_'+count+'" name="color_select_'+count+'" >'
  //            +'<?php echo $color_select_option; ?>'
  //            +'</select>'
  //            +'</td>'
  //
  //            +'<td>'
  //            +'<select id="size_select_'+count+'" name="size_select_'+count+'" >'
  //            +'<?php echo $size_select_option; ?>'
  //            +'</select>'
  //            +'</td>'
  //
  //            +'<td>'
  //            +'<select id="shade_select_'+count+'" name="shade_select_'+count+'" >'
  //            +'<?php echo $shade_select_option; ?>'
  //            +'</select>'
  //            +'</td>'
  //
  //            +'<td><input type="text" style="width:90px;height:18px;" id="ref_no_'+count+'" name="ref_no_'+count+'" ></td>'
  //            +'<td><input type="text" style="width:90px;height:18px;" id="unit_type_'+count+'" name="unit_type_'+count+'" ></td>'
  //            +'<td><input type="number" style="width:90px;height:18px;" id="con_'+count+'" name="con_'+count+'" step="0.01" value="" ></td>'
  //            +'<td><input type="number" style="width:90px;height:18px;" id="order_quantity_'+count+'" name="order_quantity_'+count+'" step="0.01" value="" ></td>'
  //            +'<td><input type="number" style="width:90px;height:18px;" id="required_quantity_'+count+'" name="required_quantity_'+count+'" step="0.01" ></td>'
  //            +'<td><input type="number" style="width:90px;height:18px;" id="total_issue_quantity_'+count+'" name="total_issue_quantity_'+count+'" step="0.01" ></td>'
  //            +'<td><input type="number" style="width:90px;height:18px;" id="balance_quantity_'+count+'" name="balance_quantity_'+count+'" step="0.01" ></td>'
  //            +'<td><input type="text" style="width:90px;height:18px;" id="remarks_'+count+'" name="remarks_'+count+'" ></td>'
