                ...
                <table class="w3-table-all w3-small" border="1">
                  ...
                  foreach ($trinhouse_details_info as $trinhouse_details){
                    ...
                    <td class="text-center">
                     ...
                     <td class="text-center">
                        <input style="width:91px;" name="issue_cal_<?php echo $i;?>" id="issue_cal_<?php echo $i?>" value="" onkeyup="issueCal(<?php echo ($i);?>),totalIssueQty(<?php echo ($i);?>),balanceQuantity(<?php echo ($i);?>)">
                      </td>
                     <td class="text-center">
...
function addNewRow(){
  ...
  rowItem = '<tr>'
             ...
             +'<td>'
             +'<select style="width:101px;" id="item_select_'+count+'" name="item_select_'+count+'" >'
             ...
             +'<td>'
             +'<select style="width:101px;" id="line_select_'+count+'" name="line_select_'+count+'" >'
             +'<?php echo $line_select_option; ?>'
             +'</select>'
             +'</td>'

             +'<td>'
             +'<select style="width:101px;" id="style_select_'+count+'" name="style_select_'+count+'" >'
             ...
             +'<td>'
             +'<select style="width:101px;" id="supplier_select_'+count+'" name="supplier_select_'+count+'" >'
             ...
             +'<td><input type="number" style="width:91px;" id="receive_quantity_'+count+'" name="receive_quantity_'+count+'" step="0.01" onkeyup="balanceQuantity('+count+')" ></td>'
             ...
             +'<td><input type="number" style="width:91px;" id="total_issue_quantity_'+count+'" name="total_issue_quantity_'+count+'" step="0.01" onkeyup="balanceQuantity('+count+')" ></td>'
  ...
  rowItem2 = '<tr>'
             ...
             +'<td>'
             +'<select id="item_select_'+count+'" name="item_select_'+count+'" style="width:101px;" >'
             +'<?php echo $item_select_option; ?>'
             +'</select>'
             +'</td>'
             +'</tr>';
...
function receiveCal(event, count){
   ...
   input.addEventListener("keyup", function(event){
     if(event.keyCode === 13){
       ...
       // if(d_receive_quantity && receive_quantity){
         d_receive_quantity_n = total + d_receive_quantity;
         receive_quantity = total + receive_quantity + d_receive_quantity;
       // }
       // elseif(d_receive_quantity){
       //   document.getElementById("d_receive_quantity_"+count).value = total + d_receive_quantity;
       //   receive_quantity = total + d_receive_quantity;
       // }
       // elseif(receive_quantity){
       //   document.getElementById("d_receive_quantity_"+count).value = total;
       //   receive_quantity =  total + receive_quantity;
       // }
       // else{
       //   document.getElementById("d_receive_quantity_"+count).value = total;
