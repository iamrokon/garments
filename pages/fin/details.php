...
<?php require_once '../../DB/fin/insert.php'; ?>
...
$finInsert = new insert();

if (isset($_POST['btn'])) {

    for($i=1; $i<=$rowNumber; $i++){

    $message = $finInsert->save(  $order_id,
                                    $_POST['finishing_country_'.$i],
                                    $_POST['finishing_size_'.$i],
                                    $_POST['finishing_quantity_'.$i],
                                    $user_id
                                 );
    }
}
                       ...
                       <table class="w3-table-all w3-small" border="1">
                           ...
                           ?>
                               <td style="color:black;width:20px;">
                                 <input type="number" name="finishing_quantity_<?php echo $i; ?>" style="width:60px;"></input>
                                 <input type="hidden" name="finishing_country_<?php echo $i; ?>" value="<?php echo $row['country_id']; ?>" style="width:60px;"></input>
                                 <input type="hidden" name="finishing_size_<?php echo $i; ?>" value="<?php echo $row['size']; ?>" style="width:60px;"></input>
                               </td>
                           <?php
                               $i++;
                               }
