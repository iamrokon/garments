...
<?php
      $ob = new select_finishing();
      $result = $ob->select_all_wash_send_not_in_finishing();
                                ...
                                <?php
                                  ...
                                  <tr>
                                      ...
                                      <td class="td-actions" class="text-center">
                                          <a href="./pages/fin/details.php?id=<?php echo $info['id']; ?>"><button class="btn  btn-xs btn-success">Details</button></a>
                                      </td>
                                  </tr>
                                 <?php $i++;} ?>
                              </tbody>
