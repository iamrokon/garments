              ...
              <table id="export-table" class="table table-striped w3-hoverable display nowrap w3-table-all w3-small" style="width:100%" style="overflow-x:auto;">
                  <thead>
                      <tr  class="btn-gradient-02">
                                    ...
                                    <th style="color:white;" class="text-center">Total Hour Value</th>
                                    <th style="color:white;" class="text-center">Creator</th>
                              ...
                              <tbody>
                                <?php
                                  ...
                                  <tr>
                                      ...
                                      <td style="color:black;" class="text-center"><?php echo $info['total_hour_value']; ?> </td>
                                      <td style="color:black;" class="text-center"><?php echo $info['user_name']; ?> </td>
                                      <td class="td-actions" class="text-center">
                                          <a class="text-center" href="./pages/fin/hourly_input_details.php?id=<?php echo $info['id']; ?>"><button class="btn  btn-xs btn-success text-center">Details</button></a>
                                      </td>
                                  </tr>
                                 <?php $i++;} ?>
                              </tbody>
