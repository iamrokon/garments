...
<?php require_once '../../DB/country/insert.php'; ?>

<?php
      $country = new insert();

      if (isset($_POST['btn'])) {
      $message = $country->save($_POST);
      }
?>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="full_name" placeholder ="Enter Country Name" required="required">
                            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="short_name" placeholder ="Enter Short Name" required="required">
                  </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="cut_off" placeholder ="Enter Cut Off" required="">
                  </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
               <div class="form-group">
                   ...
                   <div class="input-group">
                       ...
                       <input type="text" class="form-control" name="country_code" placeholder ="Enter Country Code" required="required">
                   </div>
