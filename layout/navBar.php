                ...
                <nav class="navbar fixed-top">
                    ...
                    <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
                        ...
                        <div class="navbar-header">
                            <a href="./pages/dashboard.php" class="navbar-brand">
                                <div class="brand-image brand-big">
                                    <img src="images/<?php echo $baseIcon; ?>">
                                </div>
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                            ...
                            <!-- End Notifications -->
                            <!-- User -->
                            <li class="nav-item dropdown"><a id="user" rel="nofollow" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="pages/user/<?php  echo $_SESSION['image']; ?>" alt="..." class="avatar rounded-circle"></a>
                                <ul aria-labelledby="user" class="user-size dropdown-menu">
                                    <li class="welcome">
                                        <a href="#" class="edit-profil"><i class="la la-gear"></i></a>
                                        <img src="pages/user/<?php  echo $_SESSION['image']; ?>" alt="..." class="rounded-circle">
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="#" class="dropdown-item no-padding-bottom">
                                            <div style="color:red;"><?php  echo $_SESSION['last_login']; ?></div>
                                        </a>
                                    </li>
                                    <li class="separator"></li>
                                    <li><a onclick="logOut()" rel="nofollow" name="log_out" class="dropdown-item logout text-center"><i class="ti-power-off"></i></a></li>
                                </ul>
                            </li>
                            <!-- End User -->
                            <!-- Begin Quick Actions -->
                            <li class="nav-item"><a href="#off-canvas" class="open-sidebar"></a></li>
                            <!-- End Quick Actions -->
                        </ul>
                        <!-- End Navbar Menu -->
                    </div>
